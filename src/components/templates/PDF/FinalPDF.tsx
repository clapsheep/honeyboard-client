import { FinaleProjectBoardDetailResponse } from '@/types/FinaleProject';
...
interface FinalPDFProps {
    data: FinaleProjectBoardDetailResponse;
}
const FinalPDF = ({ data }: FinalPDFProps) => {
            ...
            <Page size="A4" style={PDFStyles.page}>
                ...
                <View style={PDFStyles.infoSection}>
                    ...
                    <View style={PDFStyles.infoColumn}>
                        ...
                        {data.summary && (
                            <View style={PDFStyles.infoRow}>
                                <Text style={PDFStyles.label}>요약:</Text>
                                <Text style={PDFStyles.value}>
                                    {data.summary}
                                </Text>
                            </View>
